...
const BookDetails = () => {
  ...
  const [term, setTerm] = useState("Search Books");

  const [isLoading, setIsLoading] = useState(true);
  const [borrowedBooks, setBorrowedBooks] = useState([]); // Define borrowedBooks state
    ...
    <>
      ...
      {isLoading ? (
        ...
        <section>
          ...
          <Book {...book} key={index} onBorrow={handleBorrow} />
        ))}
